...
<section class="hero">
  <div class="container hero-grid">
    ...
    <aside class="gateway-panel" aria-label="MYH company summary">
      <div class="panel-inner">
        <span class="panel-kicker">Company summary</span>
        <h2 class="panel-title">Innovative digital brand solutions for yachting.</h2>
        <p class="panel-copy">Practical digital products for modern yachting — helping brands, owners, crew and managers support, use and understand yachts more easily.</p>
      </div>
    </aside>
  </div>
</section>
